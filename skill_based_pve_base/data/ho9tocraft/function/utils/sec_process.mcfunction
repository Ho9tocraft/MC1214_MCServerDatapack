...
execute if score ^TDHelper stage_condition matches 0 if score ^TDHelper st_tcount_time matches 1.. run scoreboard players remove ^TDHelper st_tcount_time 1
