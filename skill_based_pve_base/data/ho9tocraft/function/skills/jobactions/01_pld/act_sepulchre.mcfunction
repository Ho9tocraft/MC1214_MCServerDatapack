execute as @s at @s if score @s clickHB1 matches 1.. run function ho9tocraft:skills/jobactions/01_pld/item_fast_blade
execute as @s at @s if score @s clickHB1 matches 1.. if entity @e[distance=..3,team=ENEMY] run function ho9tocraft:skills/jobactions/01_pld/item_fast_blade
execute as @s at @s if score @s clickHB1 matches 1.. run scoreboard players set @s expireCombo 0
...
execute as @s at @s if score @s clickHB1 matches 1.. if entity @e[distance=..3,team=ENEMY] run data modify storage ffxiv:damage_path damage_amount set value 27
