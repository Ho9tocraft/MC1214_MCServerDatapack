...
execute as @s at @s if score @s clickHB1 matches 1.. if entity @e[distance=..3,team=ENEMY] run function ho9tocraft:skills/jobactions/01_pld/item_royal_authority
...
execute as @s at @s if score @s clickHB1 matches 1.. if entity @e[distance=..3,team=ENEMY] run data modify storage ffxiv:damage_path damage_amount set value 16.5
