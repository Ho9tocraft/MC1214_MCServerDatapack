...
# 2. コンボ・後処理
execute as @s[scores={job_id=100}] at @s run effect give @s absorption 30 4 false
...
execute as @s[scores={job_id=100}] at @s run item replace entity @s hotbar.1 with red_dye[max_stack_size=1,custom_data={"combinat_data":{"id":100,"combo":4}},consumable={animation:"bow",consume_seconds:0.05,has_consume_particles:false,sound:"entity.experience_orb.pickup"},use_cooldown={seconds:1.5,cooldown_group:"ffxiv:gcd_ws"},item_model="ffxiv:07_sam/midare_setsugekka",item_name={translate:"skill.ex1_exc.ws_4.name"},lore=[{translate:"skill.ex1_exc.ws_4.lore.0",color:"gray",italic:false},{translate:"skill.ex1_exc.ws_4.lore.1",color:"gray",italic:false},{translate:"skill.common.range.5m",color:"aqua",italic:false},{translate:"skill.common.area.0m",color:"aqua",italic:false},{translate:"skill.common.cast.instant",color:"green",italic:false},{translate:"skill.common.recast.10sec",color:"light_purple",italic:false}]]
execute as @s[scores={job_id=100}] at @s run scoreboard players set @s click_red 0
execute as @s[scores={job_id=100}] at @s run advancement revoke @s only ho9tocraft:job/ex1_exc/ws_03
