...
# 1. 帰還地点を設定
execute as @s[scores={job_id=100,click_red=1..},team=RED] at @s run summon armor_stand ~ ~ ~ {Silent:true,Invisible:true,Team:"RED",Tags:["Exc_RapidBlade"]}
execute as @s[scores={job_id=100,click_red=1..},team=BLU] at @s run summon armor_stand ~ ~ ~ {Silent:true,Invisible:true,Team:"BLU",Tags:["Exc_RapidBlade"]}
# 2. 転移
execute as @s[scores={job_id=100,click_red=1..},team=RED] at @s run teleport @s @e[distance=..20,sort=nearest,limit=1,team=BLU]
execute as @s[scores={job_id=100,click_red=1..},team=BLU] at @s run teleport @s @e[distance=..20,sort=nearest,limit=1,team=RED]
# 3. 範囲攻撃
...
# 4. タグ付け・帰還指示
execute as @s[scores={job_id=100,click_red=1..}] at @s run tag @s add Retop_RapidBlade
execute as @s[scores={job_id=100,click_red=1..}] at @s run schedule function ho9tocraft:skills/rt_exc_00 3s append
# 5. コンボ
execute as @s[scores={job_id=100,click_red=1..}] at @s run item replace entity @s hotbar.1 with red_dye[max_stack_size=1,custom_data={"combinat_data":{"id":100,"combo":1}},consumable={animation:"bow",consume_seconds:0,has_consume_particles:false,sound:"entity.experience_orb.pickup"},use_cooldown={seconds:1.5,cooldown_group:"gcd_ws"},item_model="ffxiv:07_sam/hyosetsu",item_name={translate:"skill.ex1_exc.ws_1.name"},lore=[{translate:"skill.ex1_exc.ws_1.lore.0",color:"gray",italic:false},{translate:"skill.ex1_exc.ws_1.lore.1",color:"gray",italic:false},[{translate:"skill.common.range.0m",color:"aqua",italic:false},{text:" / ",color:"gray"},{translate:"skill.common.area.6m",color:"aqua",italic:false}],[{translate:"skill.common.cast.instant",color:"green",italic:false},{text:" / ",color:"gray"},{translate:"skill.common.recast.1p5sec",color:"light_purple",italic:false}]],use_remainder={id:"red_dye",count:1,components:{max_stack_size:1,custom_data:{"combinat_data":{"id":100,"combo":1}},consumable:{animation:"bow",consume_seconds:0,has_consume_particles:false,sound:"entity.experience_orb.pickup"},use_cooldown:{seconds:1.5,cooldown_group:"gcd_ws"},item_model:"ffxiv:07_sam/hyosetsu",item_name:{translate:"skill.ex1_exc.ws_1.name"},lore:[{translate:"skill.ex1_exc.ws_1.lore.0",color:"gray",italic:false},{translate:"skill.ex1_exc.ws_1.lore.1",color:"gray",italic:false},[{translate:"skill.common.range.0m",color:"aqua",italic:false},{text:" / ",color:"gray"},{translate:"skill.common.area.6m",color:"aqua",italic:false}],[{translate:"skill.common.cast.instant",color:"green",italic:false},{text:" / ",color:"gray"},{translate:"skill.common.recast.1p5sec",color:"light_purple",italic:false}]]}}]
