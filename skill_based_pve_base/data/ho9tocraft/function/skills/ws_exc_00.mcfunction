...
# 4. タグ付け・帰還指示
execute as @s[scores={job_id=100}] at @s run advancement revoke @s only ho9tocraft:rclick_detect/ws_exc_00
execute as @s[scores={job_id=100}] at @s run tag @s add Retop_RapidBlade
execute as @s[scores={job_id=100}] at @s run schedule function ho9tocraft:skills/rt_exc_00 3s append
# 5. コンボ
