...
{translate:"skill.common.cast.instant",color:"green",italic:false},{translate:"skill.common.recast.1p5sec",color:"light_purple",italic:false}]]
...
{translate:"skill.common.range.0m",color:aqua,italic:false},{translate:"skill.common.area.0m",color:"aqua"},\
{translate:"skill.common.cast.instant",color:"green",italic:false},{translate:"skill.common.recast.30sec",color:light_purple,italic:false}]]
