...
# Armor
execute as @s at @s run item replace entity @s armor.head with iron_helmet[equippable={slot:"head",asset_id:"ho9tocraft:dark_knight"},\
...
execute as @s at @s run item replace entity @s armor.chest with iron_chestplate[equippable={slot:"chest",asset_id:"ho9tocraft:dark_knight"},\
...
enchantments={binding_curse:1},tooltip_display={hidden_components:["unbreakable"]}] 1
execute as @s at @s run item replace entity @s armor.legs with iron_chestplate[equippable={slot:"legs",asset_id:"ho9tocraft:dark_knight"},\
...
enchantments={binding_curse:1},tooltip_display={hidden_components:["unbreakable"]}] 1
execute as @s at @s run item replace entity @s armor.feet with iron_chestplate[equippable={slot:"feet",asset_id:"ho9tocraft:dark_knight"},\
...
# Skills
execute as @s at @s run item replace entity @s hotbar.1 with red_dye[max_stack_size=1,custom_data={"combinat_data":{"id":3,"combo":0}},consumable={animation:"bow",consume_seconds:0.05,has_consume_particles:false,sound:"entity.experience_orb.pickup"},use_cooldown={seconds:2.5,cooldown_group:"ffxiv:gcd_ws"},\
...
execute as @s at @s run item replace entity @s hotbar.2 with yellow_dye[max_stack_size=1,custom_data={"combinat_data":{"id":3,"burned":false}},consumable={animation:"bow",consume_seconds:0.05,has_consume_particles:false,sound:"entity.wither.ambient"},use_cooldown={seconds:30,cooldown_group:"ffxiv:abcd"},\
...
execute as @s at @s run item replace entity @s hotbar.3 with orange_dye[max_stack_size=1,custom_data={"combinat_data":{"id":3,"burned":true}},use_cooldown={seconds:10,cooldown_group:"ffxiv:limit_break"},\
...
# Attribute
execute as @s at @s run attribute @s max_health base set 100
execute as @s at @s run attribute @s movement_speed modifier add ho9tocraft:job_movement_env -0.05 add_multiplied_total
